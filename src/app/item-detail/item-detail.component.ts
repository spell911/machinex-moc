...
export class ItemDetailComponent implements OnInit {
  ...
  onChange(data: string, isChecked: boolean, byForm: string) {
    ...
    var i;
    if (byForm == "guideForm") {
      FormArray = <FormArray>this.guideForm.controls.guide;
    } else if (byForm == "controlForm") {
      FormArray = <FormArray>this.controlForm.controls.control;
    } else {
      FormArray = <FormArray>this.languageForm.controls.language;
    }
  ...
  checkAll(ele, type, btn) {
    ...
    const controlFormArray = <FormArray>this.controlForm.controls.control;
